    ...
    <div className="min-h-screen bg-white text-kontrol-dark font-sans selection:bg-kontrol-blue/20">
      ...
      <nav className="fixed top-0 left-0 right-0 h-20 bg-white/80 backdrop-blur-md border-b border-kontrol-border z-[100] px-6 lg:px-12 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black tracking-tighter">KONTROL <span className="text-kontrol-blue">ERP</span></span>
        </div>
      ...
      <section className="pt-40 pb-20 px-6 lg:px-12 max-w-7xl mx-auto text-center relative overflow-hidden">
        ...
        <h1 className="text-4xl lg:text-6xl font-black tracking-tighter leading-[0.9] mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
          <button 
            ...
            className="w-full sm:w-auto px-8 py-3.5 bg-kontrol-blue text-white font-black rounded-2xl hover:bg-kontrol-blue-hover transition-all shadow-xl shadow-blue-200 flex items-center justify-center gap-2 group"
          >
            Démarrer gratuitement
            <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="w-full sm:w-auto px-8 py-3.5 bg-white border border-kontrol-border text-kontrol-dark font-black rounded-2xl hover:bg-kontrol-bg transition-all">
            Voir la démo
          </button>
        </div>
      ...
      <section id="features" className="py-24 px-6 lg:px-12 bg-kontrol-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl lg:text-4xl font-black tracking-tighter mb-4">Tout ce dont vous avez besoin.</h2>
      ...
      <section id="pricing" className="py-20 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl lg:text-4xl font-black tracking-tighter mb-3">Un tarif simple et transparent.</h2>
          ...
          <div className="max-w-[400px] mx-auto bg-kontrol-dark rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl">
            ...
            <button 
              onClick={() => onLoginClick('register')}
              className="w-full py-3.5 bg-white text-kontrol-dark font-black rounded-xl hover:bg-kontrol-blue hover:text-white transition-all shadow-xl text-sm"
            >
      ...
      <section id="about" className="py-24 px-6 lg:px-12 bg-kontrol-dark text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
          <div>
            ...
            <h2 className="text-3xl lg:text-5xl font-black tracking-tighter leading-tight mb-6">
            ...
            <div className="aspect-square bg-white/5 rounded-[60px] border border-white/10 p-12 flex flex-col justify-between">
              ...
              <div className="space-y-6">
                <div className="p-6 bg-white/5 rounded-3xl border border-white/10">
                  <p className="text-white/60 text-sm italic">"Notre vision est de créer des outils si intuitifs qu'ils deviennent invisibles, laissant l'entrepreneur se concentrer sur ce qu'il aime."</p>
              ...
              <form className="space-y-5" onSubmit={async (e) => {
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-kontrol-ink-muted uppercase tracking-widest">Nom complet</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-kontrol-ink-muted uppercase tracking-widest">Email</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-kontrol-ink-muted uppercase tracking-widest">Sujet</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-kontrol-ink-muted uppercase tracking-widest">Message</label>
                ...
                <button type="submit" className="w-full py-3.5 bg-kontrol-dark text-white font-black rounded-xl hover:bg-kontrol-blue transition-all flex items-center justify-center gap-2 group text-sm">
                  Envoyer le message
      ...
      <footer className="py-12 px-6 lg:px-12 border-t border-kontrol-border">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
            <div className="flex items-center gap-3">
              <Logo size="sm" className="border-none shadow-none" />
              <span className="text-sm font-black tracking-tighter">KONTROL by INNOV'KORP</span>
            </div>
